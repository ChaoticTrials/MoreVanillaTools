...
public class ModItems {
    ...
    public static final Item boneKnife = new KnifeBase(ToolMaterials.BONE, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.BONE, -1.0f, -2.0f)));
    ...
    public static final Item coalKnife = new KnifeBase(ToolMaterials.COAL, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.COAL, 1.0f, -2.0f)));
    ...
    public static final Item copperKnife = new KnifeBase(ToolMaterials.COPPER, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.COPPER, -1.0f, -2.0f)));
    ...
    public static final Item emeraldKnife = new KnifeBase(ToolMaterials.EMERALD, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.EMERALD, -4.7f, -2.0f)));
    ...
    public static final Item enderKnife = new KnifeBase(ToolMaterials.ENDER, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.ENDER, -4.0f, -2.0f)));
    ...
    public static final Item fieryKnife = new KnifeBase(ToolMaterials.FIERY, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.FIERY, -3.5f, -2.0f)));
    ...
    public static final Item glowstoneKnife = new KnifeBase(ToolMaterials.GLOWSTONE, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.GLOWSTONE, -2.5f, -2.0f)));
    ...
    public static final Item lapisKnife = new KnifeBase(ToolMaterials.LAPIS, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.LAPIS, -1.5f, -2.0f)));
    ...
    public static final Item netherKnife = new KnifeBase(ToolMaterials.NETHER, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.NETHER, -2.0f, -2.0f)));
    ...
    public static final Item obsidianKnife = new KnifeBase(ToolMaterials.OBSIDIAN, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.OBSIDIAN, -5.5f, -2.0f)));
    ...
    public static final Item paperKnife = new KnifeBase(ToolMaterials.PAPER, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.PAPER, 0.0f, -2.0f)));
    ...
    public static final Item prismarineKnife = new KnifeBase(ToolMaterials.PRISMARINE, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.PRISMARINE, -4.5f, -2.0f)));
    ...
    public static final Item quartzKnife = new KnifeBase(ToolMaterials.QUARTZ, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.QUARTZ, -4.5f, -2.0f)));
    ...
    public static final Item redstoneKnife = new KnifeBase(ToolMaterials.REDSTONE, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.REDSTONE, -1.5f, -2.0f)));
    ...
    public static final Item slimeKnife = new KnifeBase(ToolMaterials.SLIME, new Item.Properties().attributes(DiggerItem.createAttributes(ToolMaterials.SLIME, -6.5f, -1.0f)));

    public static final Item coalBriquette = new ItemBase(MoreVanillaTools.getInstance(), new Item.Properties()) {
