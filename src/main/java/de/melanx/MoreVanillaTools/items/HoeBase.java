...
public class HoeBase extends HoeItem {
    ...
    public HoeBase(ToolMaterials tier, Properties properties) {
    ...
    public int getEnchantmentLevel(@Nonnull ItemStack stack, Holder<Enchantment> enchantment) {
        if (enchantment.is(Enchantments.KNOCKBACK) && stack.getItem() instanceof HoeBase item && item.tier == ToolMaterials.SLIME) {
            return 3;
        }
