...
public class PickaxeBase extends PickaxeItem implements BaseTool {
    ...
    public PickaxeBase(ToolMaterials tier, Properties properties) {
    ...
    public int getEnchantmentLevel(@Nonnull ItemStack stack, Holder<Enchantment> enchantment) {
        if (enchantment.is(Enchantments.KNOCKBACK) && stack.getItem() instanceof PickaxeBase item && item.tier == ToolMaterials.SLIME) {
            return 3;
        }
