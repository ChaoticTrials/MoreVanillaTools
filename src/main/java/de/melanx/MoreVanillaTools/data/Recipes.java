...
public class Recipes extends RecipeProviderBase implements CompressionExtension, CraftingExtension {
    ...
    protected void setup() {
        ...
        this.makeTools(Ingredient.of(Tags.Items.DUSTS_GLOWSTONE), ModItems.glowstoneSword, ModItems.glowstoneAxe, ModItems.glowstonePickaxe, ModItems.glowstoneShovel, ModItems.glowstoneHoe);
        this.makeTools(Ingredient.of(Tags.Items.GEMS_LAPIS), ModItems.lapisSword, ModItems.lapisAxe, ModItems.lapisPickaxe, ModItems.lapisShovel, ModItems.lapisHoe);
        ...
        this.makeTools(Ingredient.of(Tags.Items.GEMS_QUARTZ), ModItems.quartzSword, ModItems.quartzAxe, ModItems.quartzPickaxe, ModItems.quartzShovel, ModItems.quartzHoe);
        this.makeTools(Ingredient.of(Tags.Items.DUSTS_REDSTONE), ModItems.redstoneSword, ModItems.redstoneAxe, ModItems.redstonePickaxe, ModItems.redstoneShovel, ModItems.redstoneHoe);
